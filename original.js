(function() {
    ...
    function bm() {
        ...
        this.c7 = function(t, l) {
            return !bw.bx() || t < cA || l < cB - cC.c1 - g * bw.bz(13).height - 2 * cA || l > cB - cC.c1 - 2 * cA ? !1 : t < cA + g * bw.bz(13).width ? (cD.cE(0),
                !0) : t < 2 * cA + g * bw.bz(13).width ? !1 : t < 2 * cA + 2 * g * bw.bz(13).width ? (cD.cE(1),
                !0) : !1
        }
        ;
        this.cF = function() {
    ...
    function ck(g, k) {
        ...
        for (t = bM[g].length - 1; 0 <= t; t--)
            for (l = 3; 0 <= l; l--) {
                ...
                if (y === b8 || b5.bE(bM[g][t] + aV[l]) && y !== g && (k || ch(g, y)))
                    return ci[cg++] = y,
                        !0
            }
        return !1
    ...
    function dK(g, k, t, l) {
        ...
        cn(g) || (cl() ? (dN(g, k),
            dO(g, b8, t)) : (ce.dP(dG.dQ[t]) ? l = cs(g) : (cp() && ce.dP(dG.dS[t]) && cr(),
            l = cv(g)),
            dR(g, k, l),
            dO(g, l, t)))) : 0 < bN[g].length && ce.random() < ce.value(60) && dE.dF(g, t) || (dG.dH(g - cq, 200),
            dI(g, k, t, l))
    }
    function dT(g, k) {
        cY(g, !1) || ck(g, !1) ? (d7[g] = 1,
    ...
    function dL(g, k, t) {
        !cY(g, !0) && !ck(g, !0) || cn(g) || (cl() ? dN(g, k) : ce.dP(dG.dQ[t]) ? dR(g, k, cs(g)) : (cp() && ce.dP(dG.dS[t]) && cr(),
            dR(g, k, cv(g))))
    }
    function db(g, k) {
        if (cY(g, !0) || ck(g, !0))
    ...
    function fI() {
        ...
        this.fN = function(x, A, B, C) {
            0 !== fG[x] && 2 !== fU[k] && f0.co(x, b5.f2(B, C)) && ez(x, f0.f1(), b5.f2(B, C), as(A * ax[x], 1E3)) && x === aw && (b0.b1[0] += A,
                b0.b1[1]++,
                b0.b1[2]++)
        }
        ;
        ...
        ;
        this.fp = function(x) {
            0 !== fG[x] && 2 !== fU[x] && fq.fr(x) && (1 === dY ? fi.fj(x) : (e9.fl(x, x === aw ? 21 : 22),
                8 === dv ? fi.fj(1 - x) : dx ? (fm(x),
                    fn(),
                fc && fd.dF()) : this.fk(x)))
        }
    }
                ...
                for (B = l - 1; 0 <= B; B--) {
                    ...
                    if (M > C - 1 && M < G && H > E - 1 && H < F && 0 !== fG[D]) {
                        ...
                        if (!(6 > K)) {
                            ...
                            6 > L || (cH.font = bt + L + bu,
                                cH.fillText(gI.gJ.gK ? gM[D] : eP.gL(J), M, H + Math.floor(.82 * K)))
                        }
                    }
                }
            }
    ...
    function gN() {
        ...
        var l, y, n, z, x, A, B, C, E, G, F, M, H, D = !1, K = !1;
        this.gg = function() {
            return D
        }
        ;
    ...
    function j3() {
        ...
        this.dF = function() {
            fc = !1;
            for (var g = 0; g < cq; g++)
                0 !== fG[g] && 0 === bU[g] && j4.hr(g);
            0 !== fG[aw] ? (b0.b1[7] = bU[aw],
                b0.b1[8] = ax[aw],
                eR.cE(),
                eB.j5(),
    ...
    var cq, j0, dq, iz, b8 = 512, hP = 512, jA = 150, dx, jB, ec = 0, jC, jD, jE, he = 512, at = 2, aw, gl, fc, jF, dA, jG, dv, jH, fd, im, jI;
    ...
    function jz() {
        ...
        function t(L) {
            return -1 === L || 0 === L || 6 === L || !y[5] && (8 === L || !y[4] && 7 === L) || !y[7] && (2 === L || !y[6] && 1 === L) || 3 === L && !y[2] || 5 === L && !y[1] && !y[5] && !y[7] ? !1 : !0
        }
        function l(L, P) {
            return L < z - A - M || L > z + 2 * A + M || P < x - A - M || P > x + 2 * A + M ? -1 : 3 * (P < x - M / 2 ? 0 : P < x + A + M / 2 ? 1 : 2) + (L < z - M / 2 ? 0 : L < z + A + M / 2 ? 1 : 2)
        }
        var y = [], n, z, x, A, B, C, E, G, F, M, H, D, K, J;
        this.l2 = [];
        this.bp = function() {
            K = [];
            y = [];
        ...
        this.c7 = function(L, P) {
            ...
            if (2 === I) {
                if (y[7]) {
                    ...
                    0 < K.length && (eQ.lQ(1, K, !0) && (e9.lR(K, G),
                        iu.lS(K, G)),
                        K = []);
                    this.lH();
                    return 1
            ...
            if (4 === I)
                return y[0] ? fc ? (this.lH(),
                    dx ? (fd.cQ(0, b5.gF(F), b5.cF(F)),
                        fd.dF()) : iu.lY(1E3, b5.gF(F), b5.cF(F))) : (this.lH(),
                    e9.lU(),
                    dx ? fM(aw, G, eR.lV()) : (!jF || 300 < eB.lX()) && iu.lW(eR.lV(), G === b8 ? aw : G)) : y[8] ? (this.lH(),
                    eH.lZ(G, eR.lV())) : this.lH(),
                    1;
            if (5 === I)
                return y[1] ? (this.lH(),
                    e9.lU(),
                    dx ? eG.fN(aw, eR.lV(), b5.gF(F), b5.cF(F)) : iu.lY(eR.lV(), b5.gF(F), b5.cF(F)),
                    1) : 0;
            if (7 === I && y[4])
                return this.lH(),
                    n = a5.show(L, P),
                    1;
            if (8 === I)
                return y[5] ? (eQ.lQ(0, [G], !0) && (e9.la(G, 0),
                    iu.lb(G)),
                    this.lH(),
                    1) : 0;
            this.lH();
        ...
        this.click = function(L, P) {
            ...
            if (!b5.b6(R))
                return !1;
            if (2 === ec)
                return 1 <= a5.lf && (G = b5.bF(R),
                    this.lG(G)) ? (G === aw && this.lH(),
                    y[4] = !0,
                    this.lg(L, P)) : !1;
            F = b5.f2(I, O);
            if (fc)
    ...
    function k0() {
        ...
        this.c7 = function(B, C) {
            ...
            return this.lw ? 0 === E ? (je(),
                2) : 1 === E ? (this.m2(),
                2) : 2 === E ? (this.fr(aw) && (dx ? eG.fp(aw) : iu.m5(),
                this.m2()),
                2) : 3 === E && 2 <= b0.m6 ? (hy.m2(),
                c4.c5 = !0,
                2) : hy.lE ? 1 : (this.m2(),
    ...
    function k1() {
        ...
        function E(I, O) {
            ...
            for (R = F.length - 1; 0 <= R; R--)
                F[R].id !== I || O !== b8 && F[R].player !== O || (F.splice(R, 1),
                    N = !0);
            return N
        }
        function G(I, O) {
        ...
        this.lx = function() {
            ...
            if (0 < F.length) {
                ...
                for (I = O.length - 1; 0 <= I; I--)
                    A(O[I].gf, O[I].l, O[I].id, O[I].player, O[I].mW, O[I].mX, O[I].mY, O[I].mZ)
            }
            this.ma()
        }
        ;
                    ...
                    if (50 === F[T].id) {
                        if (I >= gE - K - H - F[T].c1)
                            return I >= gE - K - H ? (T = F[T].player,
                                this.la(T, 0),
                                iu.lb(T)) : eV.gj(F[T].player, 800, !1, 0),
                                !0;
                        break
                    }
                    if (I >= gE - F[T].c1 - H)
                        return F[T].mZ && (eV.gj(F[T].player, 800, !1, 0),
                        0 <= F[T].mY && (R = F[T].mY,
                            F[T].mY = F[T].player,
                            F[T].player = R)),
                            !0;
        ...
        this.fl = function(I, O) {
            0 === O ? (b0.b1[I < cq ? 4 : 3]++,
                c2.cQ(I, 0),
                A(q ? 100 : 160, "You conquered " + gM[I] + ".", 0, I, "rgb(10,220,10)", i1, -1, !1)) : 1 === O ? (E(50, b8),
                c2.cQ(I, 1),
                A(360, "You were conquered by " + gM[I] + ".", 0, I, "rgb(255,40,40)", i1, -1, !0),
                eV.gj(I, 2700, !0, 0)) : 2 === O ? (c2.cQ(I, 2),
                A(0, "Congratulations! You won the game.", 0, I, "rgb(10,255,255)", i1, -1, !0),
                eV.gj(I, 2700, !0, 0)) : 3 === O ? (c2.cQ(I, 2),
                A(0, gM[I] + " won the game.", 0, I, cK, i1, -1, !0),
                eV.gj(I, 2700, !0, 0)) : 4 === O ? (j0--,
                iz--,
                this.ml(1, I, I)) : 5 === O ? 2 !== fU[I] && hx.lG(aw) && (B(1, 5),
                eA.mn(I) ? A(180, gM[I] + " has broken the non-aggression pact and invades you!", 1, I, C(255, 200, 180), i1, -1, !0) : A(180, gM[I] + " is attacking you!", 1, I, "rgb(255,70,10)", i1, -1, !0)) : 18 === O ? A(255, "Choose your start position!", 18, 0, cK, i1, -1, !1) : 21 === O ? A(220, "You surrendered!", O, 0, "rgb(255,40,40)", i1, -1, !1) : 22 === O && this.ml(2, I, I)
        }
        ;
        this.mo = function(I) {
        ...
        this.is = function(I) {
            ...
            I ? (9 === dv ? (I = "The Resistance defeated the virus.",
                ...
                A(0, I, 40, 0, "rgb(10,220,10)", i1, -1, !1)) : (9 === dv ? (I = "Mankind lost the war against the virus.",
        ...
        this.iK = function(I, O, R, N) {
            1 === eD.n2() && (A(0, I[0].name + ": " + im.iI(I[0].iF) + " -> " + O, 66, 0, cK, N[0], -1, !1),
                A(0, I[1].name + ": " + im.iI(I[1].iF) + " -> " + R, 66, 1, cK, N[1], -1, !1))
        }
        ;
        this.ir = function(I) {
        ...
        this.la = function(I, O) {
            0 === O ? E(50, I) ? (A(128, "You signed a non-aggression pact with " + gM[I] + ".", 52, I, C(180, 255, 180), i1, -1, !0),
                eA.n4(I, 2, 255)) : A(384, "You asked " + gM[I] + " to sign a non-aggression pact.", 51, I, C(210, 210, 255), i1, -1, !0) : E(51, I) ? (A(128, gM[I] + " accepted the non-aggression pact.", 52, I, cK, "rgba(60,120,10,0.9)", -1, !0),
                eA.n4(I, 2, 255)) : (A(384, gM[I] + " requests a non-aggression pact.", 50, I, cK, "rgba(90,90,90,0.9)", -1, !0),
                eA.n4(I, 2, 96))
        }
        ;
        ...
        this.nN = function(I) {
            ...
            1 === O ? (O = G(R, 0 === I) + z[I],
            0 === I && (O += G(k[I], !0) + "."),
                A(t[I], O, 7, k[I], cK, i1, -1, !0)) : 2 <= O && (O = G(R, 0 === I) + " and " + (O - 1) + " other player" + (2 === O ? "" : "s") + n[I],
        ...
        this.dF = function() {
            ...
            if (128 !== L && (L++,
                ...
                for (I = 5,
                         O = dY - 1; 0 <= O; O--)
                    1 === fU[dZ[O]] && 0 < I-- && A(240, gM[dZ[O]] + " joined the game.", 1, dZ[O], gH, "rgba(255,255,255,0.75)", -1, !0);
            this.j1(!1)
        }
        ;
        this.cG = function() {
    ...
    function nU() {
        ...
        this.c7 = function(g, k) {
            ...
            if (-1 === t)
                return !1;
            0 === t ? (f.nZ(2),
                this.lE = !1) : 1 === t ? na.bp(nb, !0) : 2 === t && (f.nZ(1),
                this.lE = !1);
            return c4.c5 = !0
        }
        ;
    ...
    function pR(g, k) {
        if (0 === ec)
            ...
            var t = fq.c7(g, k);
            2 === t || eM.c7(g, k) || (gm.c7(g, k) ? c4.c5 = !0 : eR.pV(g, k) ? (gm.gn = !1,
            eR.pW(g, k) && (c4.c5 = !0)) : e9.c7(g, k) || eS.c7(g, k) || 0 === t && hx.lF(g, k))
        }
    }
    function pD(g) {
        p3 = !1;
    ...
    function pX(g, k) {
        0 === ec ? aJ.lo(g, k) : hy.lo(g, k) || (hx.lE() ? hx.lo(g, k) : fq.lo(g, k) || (eR.pZ ? eR.lo(g, k) && (c4.c5 = !0) : (eM.lo(g, k),
        gm.gn && gm.lo(g, k) && (c4.c5 = !0))))
    }
    function pG(g) {
        g.preventDefault();
    ...
    function k3() {
        function g(C) {
            ...
            E > z + 2 * A && (n[C].i0.fillRect(E - z - A, 0, 1, A),
                n[C].i0.fillText(gM[n[C].cM], Math.floor((E - z) / 2), Math.floor(.57 * A)));
            var G = 0 !== n[C].id ? 0 : A;
        ...
        function t(C) {
            ...
            pp.font = x;
            var E = z;
            C.cM < b8 && 0 === C.id && (E += Math.floor(pp.measureText(gM[C.cM] + "000").width));
            E += A;
            0 === C.id && (E += A);
            C.ls.width = E;
            C.ls.height = A;
        ...
        this.c7 = function(C, E) {
            ...
            for (G = n.length - 1; 0 <= G; G--) {
                ...
                if (E >= D - M && E <= D + A + M) {
                    if (C >= H - F && C <= H + A + F)
                        return n[G].py || (n[G].ps = !0,
                            n[G].py = !0,
                            0 === n[G].id ? dx ? eG.fO(aw, n[G].cM) : iu.qC(n[G].cM === b8 ? aw : n[G].cM) : dx ? eG.fQ(aw, n[G].id) : iu.qD(n[G].id)),
                            !0;
                    if (0 === n[G].id && C >= H + K - A - F && C <= H + K + F)
                        return dx ? fM(aw, n[G].cM, eR.lV()) : iu.lW(eR.lV(), n[G].cM === b8 ? aw : n[G].cM),
                            !0
                }
            }
            return !1
    ...
    function k8() {
        ...
        ;
        this.dF = function() {
            0 !== fG[aw] && 2 !== fU[aw] && A !== ax[aw] && (y = me(ax[aw], y),
                B = ax[aw] > A && 10 <= ax[aw],
                A = ax[aw],
                x = !0)
        }
    ...
    function k9() {
        ...
        this.bp = function() {
            ...
            for (S = b8 - 1; 0 <= S; S--)
                ...
                I[S] > ba) {
                    var Q = gM[S];
                    for (V = gM[S].length - 1; 1 <= V && !(Q = Q.substring(0, V),
        ...
        this.st = function(S) {
            ...
            if (I[S] <= ba)
                return gM[S];
            var ta = gM[S];
            for (V = gM[S].length - 2; 1 <= V && !(ta = ta.substring(0, V),
                I[S] = Math.floor(B.measureText(ta + "...]").width),
            I[S] <= ba); V--)
                ;
            ta += "...]";
            P[S] === S ? (P[S] = b8 + L.length,
                L.push(ta)) : L[P[S] % b8] = ta;
            return ta
        }
        ;
        this.lx = function(S) {
            ...
            if (!S) {
                B.font = sP;
                for (S = b8 - 1; 0 <= S; S--)
                    I[S] = Math.floor(B.measureText(P[S] === S ? gM[S] : L[P[S] % b8]).width);
                g()
            }
        }
        ;
        ...
        ;
        this.eb = function(S) {
            U && (S || 0 === c4.dU() % gI.su[gI.gJ.sv]) && (U = !1,
                g())
        }
        ;
        this.dF = function() {
            ...
            a: {
                ...
                for (V = ba = sR[aw] >= x - 1 ? x - 2 : x - 1; 0 <= V; V--)
                    if (N[V] !== en[V] || T[V] !== bU[en[V]])
                        break a;
                if (ba !== x - 2 || N[x] === sR[aw] && T[x] === bU[aw])
                    U = S
            }
            for (S = x - 1; 0 <= S; S--)
                N[S] = en[S],
        ...
        function g() {
            ...
            for (var N = 0, T = 0; T < D.length; T++)
                if (J[T]) {
                    ...
                    z.fillText(D[T], E, U);
                    z.textAlign = op;
                    5 === T && 0 !== fG[aw] && ax[aw] >= ay.dJ(aw) ? (z.fillStyle = om,
    ...
    function kf() {
        function g(n, z, x, A, B, C, E) {
            0 !== fG[n] && 0 !== bU[n] && (x = gE * ((d0[n] + cz[n] + 1) / 2 - x) / (B - x) - .5 * z,
    ...
    function u8() {
        ...
        this.uI = .9;
        this.uJ = .08;
        var g = ["Best Players", "Best Clans", "LEGENDS NEVER DIE", "THE NEVER ENDING WAR"], k, t = [-1E6, -1E6];
        this.position = [0, 0];
        this.uO = [0, 0];
        this.bp = function() {
            this.mE = [null, null];
    ...
    function uh() {
        ...
        ;
        this.cG = function() {
            this.lE && (cH.imageSmoothingEnabled = !0,
                cH.setTransform(1, 0, 0, 1, g, k),
                cH.fillStyle = i1,
                cH.fillRect(0, 0, C, l),
                cH.lineWidth = p2,
    ...
    function kE() {
        ...
        ;
        this.vr = function() {
            return na.lH() || cC.ur() ? !0 : cD.lE ? (cD.lE = !1,
                !0) : !1
        }
        ;
        this.aK = function() {
    ...
    function kj() {
        ...
        this.eZ = function() {
            0 < l && c4.gf > t && (l--,
                t += 4500,
            0 === c4.wO && 0 === c4.wP && (0 === l && eD.jf < eD.wQ && (eD.jf += eD.wR),
                eD.rp(eD.jf, 5)))
        }
        ;
        this.wS = function() {
    ...
    function kI() {
        ...
        ;
        this.xX = function() {
            for (var t = Math.floor(b8 / this.dz.length), l = b8 % this.dz.length, y = this.dz.length - 1; 0 <= y; y--)
                this.dz[y].mv = t;
            this.dz[0].mv += l
        }
        ;
    ...
    function p9() {
        ...
        ;
        this.ur = function() {
            return this.mE[1].ik.lE ? (this.mE[1].ik.c7(-5E3, -5E3, 0),
                !0) : this.mE[2].ik.lE ? (this.mE[2].ik.c7(-5E3, -5E3),
                !0) : !1
        }
        ;
        this.c7 = function(g, k, t) {
            if (t) {
                if (this.mE[1].ik.lE)
                    return this.mE[1].ik.c7(g, k, 0),
                        !0;
                if (this.mE[2].ik.lE)
                    return this.mE[2].ik.c7(g, k),
                        !0
            }
            g = this.pV(g, k);
            if (t) {
        ...
        this.lo = function(g, k) {
            return this.mE[1].ik.lE ? (this.mE[1].ik.lo(g, k),
                !0) : this.mE[2].ik.lE ? (this.mE[2].ik.lo(g),
                !0) : !1
        }
        ;
        this.vI = function() {
        ...
        function g(n, z, x, A) {
            ...
            t[n].onload = function() {
                ...
                bw.bx() && (uY.bv(),
                    hx.l3(),
                    a5.bp(),
                    vv.uu([t[8], t[16], t[7], t[9], t[10]], [!b, 0 === d, !0, !0, !0]),
                    c4.c5 = !0,
                    t[7] = y,
                    t[8] = y,
                    t[9] = y,
            ...
            if (!(5 <= d || b)) {
                ...
                for (var E, G = document.cookie.split(";"), F = G.length - 1; 0 <= F; F--) {
                    ...
                    3 < G[F].length && (C = n.indexOf(G[F].substring(0, 2)),
                        E = G[F].indexOf("="),
                        0 <= C && 2 === E ? z[C] = G[F].substring(E + 1, G[F].length) : 0 < E && y(G[F].substring(0, E), "0", 0))
                }
                z[9] || (z[9] = "0");
                a: {
                    for (C = x - 1; 0 <= C; C--)
                    ...
                    for (l = k - 2; 0 <= l; l -= 2) {
                        ...
                        if (y < b8 && 0 === fG[y])
                            ...
                            if (y >= b8 && lh(aw) || y < b8 && lm(aw, y))
                                dx ? fM(aw, y, n) : iu.lW(n, y === b8 ? aw : y),
                                    g(l)
                        }
                    }
                }
    ...
    function kP() {
            ...
            for (var Q = gC / g7, X = gD / g7, fa = (gE + gC) / g7, ra = (cB + gD) / g7, ha, ia, ma, sa, pa, ua = 0 !== fG[aw] && hx.lG(aw), ya = dY - 1; 0 <= ya; ya--)
                ...
                !(sa < R || sa >= L) && F[ma] + H[ma] > Q && F[ma] < fa && M[ma] + D[ma] > X && M[ma] < ra) {
                    ...
                    if (ua && (0 < ca[ma + b8] || 0 < ca[ma + 2 * b8] || 0 < ca[ma + 3 * b8] || 0 < ca[ma + 4 * b8])) {
                        ...
                        for (pa = 1; 5 > pa; pa++)
                            0 < ca[za + pa * b8] && (Aa = Ea,
                                ...
                                W.globalAlpha = z(Aa),
                                W.drawImage(1 === Da ? a5.l7[la[Ba + b8]] : 2 === Da && 255 > Fa ? hx.l5[2] : hx.l4[Da + 3], 0, 0),
                                W.globalAlpha = 1,
                                W.setTransform(1, 0, 0, 1, 0, 0),
                                wa -= 2)
                    }
                    ...
                    pa < R || (W.font = bt + pa + bu,
                        W.fillText(gI.gJ.gK ? gM[ma] : eP.gL(ax[ma]), ha, ia + Math.floor(.78 * sa)))
                }
        }
        ...
        ;
        this.cG = function() {
            Y && (1 !== Z ? (cH.imageSmoothingEnabled = !0,
        ...
        ;
        this.eb = function(Q) {
            return (Q ? 0 === ++ba % gI.su[gI.gJ.a13] : 0 === c4.dU() % gI.su[gI.gJ.a13]) ? (ba = 0,
                l(),
                !0) : !1
        }
        ;
    ...
    function ko() {
        ...
        ;
        this.dF = function() {
            dx || (30 === this.nf && 2140 <= c4.dU() && this.a1m(),
    ...
    function a29() {
        for (var g, k = dY - 1; 0 <= k; k--)
            bU[dZ[k]] <= as(hd[dZ[k]], 4) ? 1E3 >= bU[dZ[k]] && (2 !== fG[dZ[k]] || 0 === bU[dZ[k]]) && fm(dZ[k]) : bU[dZ[k]] >= hd[dZ[k]] ? hd[dZ[k]] = bU[dZ[k]] : (g = as(hd[dZ[k]] - bU[dZ[k]], 1E3),
                hd[dZ[k]] -= 1 > g ? 1 : g)
    }
    function iw() {
        var g, k = 0;
    ...
    var pB, cH, a2B, a2C, r, s, pO, bq, gE, cB, pS, a2D, b, c, e, d, q, a2E = !1, a2F, a2G, i, h1, tS, hB, a5, b0, hy, vn, c4, dW, eT, cD, fi, vv, na, uY, a2H, a2I, a2J = 0, a2K = "", a2L = !1;
    function a2M() {
        a2I = 2;
        a2C = 4029;
    ...
    function a2P(g) {
        400 > c4.gf || (8 !== aJ.pe() && aJ.ur(g) ? c4.c5 = !0 : "Escape" === g.key ? aJ.aK() : "ArrowLeft" === g.key ? gq.a2d(3) : "ArrowUp" === g.key ? gq.a2d(0) : "ArrowRight" === g.key ? gq.a2d(1) : "ArrowDown" === g.key ? gq.a2d(2) : "h" === g.key && 1 <= ec && (gl = !gl,
            c4.c5 = !0))
    }
    function a2O() {
    ...
    function kR() {
        ...
        this.a2f = function() {
            ...
            this.e3 = 0;
            this.e4 = [0, 0, 0, 0, 0, 0];
            cq <= k[0] ? (this.e3 = t[0] - cq,
                this.e4[1] = t[1] - as(t[1] * cq, k[0]),
                this.e4[0] = 512 - this.e4[1] - t[0]) : cq <= k[1] ? (this.e3 = t[0] - k[0] - as((t[0] - k[0]) * (cq - k[0]), k[1] - k[0]),
                this.e4[0] = 512 - this.e3 - cq) : cq <= k[2] ? (this.e4[0] = 512 - k[1] - as((512 - k[1]) * (cq - k[1]), k[2] - k[1]),
                this.e4[1] = 512 - cq - this.e4[0]) : cq <= k[3] ? (this.e4[1] = 512 - k[2] - as((512 - k[2]) * (cq - k[2]), k[3] - k[2]),
                this.e4[2] = 512 - cq - this.e4[1]) : cq <= k[4] ? (this.e4[2] = 512 - k[3] - as((512 - k[3]) * (cq - k[3]), k[4] - k[3]),
                this.e4[3] = 512 - cq - this.e4[2]) : cq <= k[5] ? (this.e4[3] = 512 - k[4] - as((512 - k[4]) * (cq - k[4]), k[5] - k[4]),
                this.e4[4] = 512 - cq - this.e4[3]) : cq <= k[6] ? (this.e4[4] = 512 - k[5] - as((512 - k[5]) * (cq - k[5]), k[6] - k[5]),
                this.e4[5] = 512 - cq - this.e4[4]) : this.e4[5] = 512 - cq;
            t = this.e3;
            for (k = 0; 6 > k; k++)
                t += this.e4[k];
            if (t > dq) {
    ...
    function kS() {
        ...
        this.jU = function() {
            ...
            for (k = aZ * aa - 1; 0 <= k; k--)
                l = 4 * k,
                3 !== y[l + 2] && (n[l + 2] > n[l + 1] && n[l + 2] > n[l] ? y[l + 2] = 2 : (y[l + 2] = 1,
                    t++));
            this.nG = (aZ - 2) * (aa - 2);
            this.nL = 0;
            if (a2v(x6)) {
                        ...
                        if (g(x, A, C, B))
                            return B = n[z][B],
                                0 === z ? 1 === B.id ? (gI.xy = 1 === gI.xy ? 2 : 2 === gI.xy ? eD.wQ : 1,
                                    ...
                                    c4.c5 = !0) : 2 === B.id ? (z = 1,
                                    c4.c5 = !0) : 3 === B.id && (z = 2,
                                    c4.c5 = !0) : 1 === z ? 1 === B.id ? (gI.gJ.nQ = !gI.gJ.nQ,
                                    B.n6 = gI.gJ.nQ ? 130 : 0,
                                    gI.vJ(),
                                    c4.c5 = !0) : 2 === B.id ? (gI.gJ.a4X = !gI.gJ.a4X,
                                    gI.a4W(),
                                    gI.vJ(),
                                    c4.c5 = !0) : 3 === B.id ? (gI.gJ.rM = !gI.gJ.rM,
                                    B.n6 = gI.gJ.rM ? 130 : 0,
                                    gI.vJ(),
                                    c4.c5 = !0) : 4 === B.id ? (gI.gJ.gK = !gI.gJ.gK,
                                    B.n6 = gI.gJ.gK ? 130 : 0,
                                    gI.vJ(),
                                    c4.c5 = !0) : 5 === B.id ? (gI.gJ.a4Y++,
                                    gI.gJ.a4Y %= 8,
                                    gI.a4Z(B.id),
                                    gI.vJ(),
                                    jt.xl(),
                                    c4.c5 = !0) : 6 === B.id ? (gI.gJ.a0s++,
                                    gI.gJ.a0s %= 10,
                                    gI.a4Z(B.id),
                                    gI.vJ(),
                                    c4.c5 = !0) : 7 === B.id ? (gI.gJ.sv++,
                                    gI.gJ.sv %= 4,
                                    gI.a4Z(B.id),
                                    gI.vJ(),
                                    c4.c5 = !0) : 8 === B.id ? (gI.gJ.a13++,
                                    gI.gJ.a13 %= 4,
                                    gI.a4Z(B.id),
                                    gI.vJ(),
                                    c4.c5 = !0) : 9 === B.id ? (gI.a4U(),
                                    gI.a4W(),
                                    gI.vJ(),
                                    jt.xl(),
                                    c4.c5 = !0) : 10 === B.id && (z = 0,
                                    c4.c5 = !0) : 1 === B.id ? (na.bp(oz, !0),
                                    na.bp(oz, !1)) : 2 === B.id ? (na.bp(p0[0], !0),
                                    na.bp(p0[0], !1)) : 3 === B.id ? (na.bp(p0[1], !0),
                                    na.bp(p0[1], !1)) : 4 === B.id ? (12 <= d && e.setState(7),
                                    na.bp(oy, !0),
                                    na.bp(oy, !1)) : 5 === B.id ? (na.bp(nb, !0),
                                    na.bp(nb, !1)) : 6 === B.id && (z = 0,
                                    c4.c5 = !0),
                                !0;
                    y = !1;
                    c4.c5 = !0;
        ...
        function k() {
            ...
            bw.bx() && (l() || y) && (y = !1,
                ...
                1 <= ec ? (eM.lx(!1),
                    ...
                    eW.lx(),
                    eT.lx(),
                    gm.rP()) : (0 === aJ.pe() ? jn.cE(0, !0) : 2 === aJ.pe() ? dy.lx() : 3 === aJ.pe() && jm.lx(),
                    aJ.vr(),
                    aJ.vw()),
                c4.c5 = !0)
        }
    ...
    function a2V() {
        ...
        ;
        this.a5n = function() {
            0 !== fG[aw] && (this.a5i[this.m6] = bU[aw],
    ...
    function a2W() {
        ...
        this.a60 = function(g, k) {
            ...
            cH.fillStyle = oP;
            for (t = 2; 0 <= t; t--)
                cH.fillText(b0.a5k[t + 8], 0, t * l / 9);
            cH.fillStyle = oO;
    ...
    function a2Y() {
        ...
        this.a6F = function() {
            var l;
            for (l = cq + e2.e3 - 1; 0 <= l; l--)
                this.dX[l] = 1;
            for (l = cq + e2.e3; l < b8; l++)
                this.dX[l] = 2;
            this.iq[1] = 7;
            this.iq[2] = 8
        }
    ...
    function bL(g) {
        for (var k = g.length, t = k - 1; 0 <= t; t--)
            b5.hp(aP, g[t]) || (g[t] = g[k - 1],
                g.pop(),
                k--)
    }
    function bO(g) {
        for (var k = g.length, t = k - 1; 0 <= t; t--)
            !b5.hp(aP, g[t]) && b5.b6(g[t]) && (g[t] = g[k - 1],
                g.pop(),
                k--)
    }
    function bP(g) {
    ...
    function bR() {
        for (var g, k, t = aQ - 1; 0 <= t; t--)
            for (g = 3; 0 <= g; g--)
                k = aS[t] + aV[g],
                b5.ym(aP, k) && b5.yn(k) && (bM[aP].push(k),
                    b5.b7(k, aP))
    }
    function bS() {
        var g;
        a: for (; d3[aP] < d2[aP]; ) {
            for (g = cz[aP]; g >= d0[aP]; g--)
                if (b5.hp(aP, 4 * (d3[aP] * aZ + g)))
                    break a;
            d3[aP]++
        }
        a: for (; d3[aP] < d2[aP]; ) {
            for (g = cz[aP]; g >= d0[aP]; g--)
                if (b5.hp(aP, 4 * (d2[aP] * aZ + g)))
                    break a;
            d2[aP]--
        }
        a: for (; d0[aP] < cz[aP]; ) {
            for (g = d2[aP]; g >= d3[aP]; g--)
                if (b5.hp(aP, 4 * (g * aZ + d0[aP])))
                    break a;
            d0[aP]++
        }
        a: for (; d0[aP] < cz[aP]; ) {
            for (g = d2[aP]; g >= d3[aP]; g--)
                if (b5.hp(aP, 4 * (g * aZ + cz[aP])))
                    break a;
            cz[aP]--
        }
    }
    ...
    function kn() {
        ...
        this.a71 = function() {
            ...
            this.a70 ? 55 > t || -1 !== c4.a6k || (this.a70 = !1,
                t = k.getUTCMinutes(),
                4 === t % 5 ? (k = k.getUTCHours(),
                    59 === t && 15 <= k && 21 >= k ? g("Upcoming Game of the Day", 0) : 14 === t % 30 ? g("Upcoming Alliance Contest", 0) : 29 === t % 30 ? g("Upcoming Battle Royale Contest", 0) : g("Upcoming One-vs-One Game", 8)) : 2 === t % 5 && g("Upcoming Zombie Game", 9)) : 55 > t && (this.a70 = !0)
        }
    }
    function ka() {
        function g() {
                    ...
                    1 === z && (z = aJ.pe(),
                        8 !== z ? 10 === z && eD.a26(y, 3243) : y !== eD.jf ? eD.a26(y, 3244) : 0 === k(n, 1) ? c4.a6j.a6v(n) : (z = k(n, 2),
                            0 === z ? 3 !== t ? eD.a26(eD.jf, 3230) : (z = k(n, 9),
                                x = k(n, 7),
                            0 !== fG[z] && 0 !== fG[aw] && (x %= a5.a6,
                                e9.mr(z, aw, x),
                                eA.n4(z, 1, x))) : 1 === z ? 2 !== t ? eD.a26(eD.jf, 3235) : (z = k(n, 9),
                            0 !== fG[z] && 0 !== fG[aw] && eQ.a1j(0, [z], !0) && e9.la(z, 1)) : 3 !== t ? eD.a26(eD.jf, 3236) : (z = k(n, 9),
                                x = k(n, 9),
                            0 !== fG[z] && 0 !== fG[x] && 0 !== fG[aw] && eQ.a1j(1, [z], !0) && (eA.n4(z, 3, 96),
                                eA.n4(x, 4, 96),
                                e9.n7(z, x)))))
            }
        }
    ...
    function kh() {
        ...
        this.c7 = function(k, t) {
            ...
            if (t < this.xV[1] + y)
                return k > this.xV[0] + this.xV[2] - 1.2 * y && (this.lE = !1),
                    !0;
    ...
    function kd() {
        ...
        this.lS = function(n, z) {
            var x, A = n.length, B = new Uint8Array(t(15 + 9 * A));
            y = 0;
            l(B, 1, 1);
            l(B, 3, 6);
            l(B, 2, 2);
